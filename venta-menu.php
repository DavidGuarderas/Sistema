      ...
      <div class="container templatemo_contactmargin">
        <div class="row"> 
          <div class="col-md-4">
            ...
            <img height="200px" width="300px" src="data:image/jpg;base64, <?php echo base64_encode($row['vImagen']);?>"  >
            <div class="clear"></div> <br>

            <div class="templatemo_address_title">Ubicación:</div><?php echo $row['vUbicacion'];?> 
            <div class="clear"></div>

            <div class="templatemo_address_left">Dormitorios:</div>
            <div class="templatemo_address_right"> <?php echo $row['vCuartos'];?> <i class="fa fa-bed" style="font-size:24px"></i> </div> 
            <div class="clear"> </div>

            <div class="templatemo_address_left">Baños:</div>
            <div class="templatemo_address_right"><?php echo $row['vBaños'];?> <i class="fa fa-bath" style="font-size:24px"></i> </div>
            <div class="clear"> </div>

            <div class="templatemo_address_left">Garages:</div> 
            <div class="templatemo_address_right"><?php echo $row['vGarages'];?> <i class="fa fa-car" style="font-size:24px"></i> </div>
            <div class="clear">  </div>

            <div class="templatemo_address_left">Pisos:</div>
            <div class="templatemo_address_right"><?php echo $row['vPisos'];?> <i class="fa fa-puzzle-piece" style="font-size:24px"></i> </div>
            <div class="clear"></div>

            <div class="templatemo_address_left">Metros Cuadrados:</div>
            <div class="templatemo_address_right"><?php echo $row['vMCuadrados'];?> m² <i class="fa fa-cube" style="font-size:24px"></i> </div>
            <div class="clear"></div>

            <div class="templatemo_address_left">Precio:</div>
            <div class="templatemo_address_right"><?php echo $row['vPrecio'];?><i class="fa fa-usd" style="font-size:24px"></i> </div>
            <div class="clear"></div>

            <div class="templatemo_address_left">Tipo de Propiedad:</div>
            <div class="templatemo_address_right"><?php echo $row['vTipoPropiedad'];?> <i class="fa fa-home" style="font-size:24px"></i> </div>
            <div class="clear"></div>
          </div>
        </div>
      </div>
