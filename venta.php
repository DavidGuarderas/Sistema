...
<div class="templatemo_workwrapper" id="templatemo_work_page">
    ...
    $query  = "SELECT * FROM venta WHERE vUbicacion='Norte'";
    ...
    <div>
      <div class="templatemo_workbox">
        <div class="gallery-item"><img height="200px" width="200px" src="data:image/jpg;base64, <?php echo base64_encode($row['vImagen']);?>" >
          <div class="overlay">
            <div class="templatemo_worktitle"><?php echo $row['vUbicacion']; ?></div>
            <div class="templatemo_workdes"><?php echo $row['vMCuadrados']; echo " m2"; ?></div>
            <div class="templatemo_worklink"><a href="data:image/jpg;base64, <?php echo base64_encode($row['vImagen']);?>" data-rel="lightbox" class="fa fa-search-plus"></a></div>
            <div class="templatemo_worklink"><a href="venta-menu.php?id=<?php echo $row['idVenta'];?>" class="fa fa-eye"></a></div>
          </div>
        </div>
      </div>
    </div>
  ...
  $query2 = "SELECT * FROM venta WHERE vUbicacion='Centro'";
  ...
  $query3 = "SELECT * FROM venta WHERE vUbicacion='Sur'";
  ...
  $query4 = "SELECT * FROM venta WHERE vUbicacion='Calderón'";
...
$query5 = "SELECT * FROM venta WHERE vUbicacion='Los Valles'";
