...
<div class="container">		
			<div class="panel panel-primary">
				<div class="panel-body">
					<form method="POST" action="editar.php?id=<?php echo $row['idTipoUsuario'];?>" enctype="multipart/form-data">
						<h4 class="text-center">Editar Propiedad en Venta</h4>
						
						<div class="form-group">
                            
                            <label class="col-sm-12 ">Nuevo Correo</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="correo" value="<?php echo $row['uEmail'];?>" required>
                                </div>
                            <label class="col-sm-12 ">Nuevo Nombre de Usuario</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="usuario" value="<?php echo $row['uUsuario'];?>" required>
                                </div>  
